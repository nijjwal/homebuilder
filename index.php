...
<div class="panel panel-default panel-body" style="margin-top:20px;">
    ...
    <div class="row">
        ...
        <div class="col-md-9 well featured-image-listing">
                ...
                $the_query = new WP_Query( array( 'mycategories' => $test ) );

                

                //$term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'mycategories' ) ); echo $term->name;
